...
RD /S /Q .\mysql\scripts 2>NUL
RD /S /Q .\mysql\backup 2>NUL
REM only if you want remove this DB
RD /S /Q .\mysql\data\test 2>NUL
...
RD /S /Q .\webdav 2>NUL
DEL /S /Q .\ctlscript.bat 2>NUL
DEL /S /Q .\killprocess.bat 2>NUL
DEL /S /Q .\properties.ini 2>NUL
DEL /S /Q .\uninstall.* 2>NUL
DEL /S /Q .\*.txt 2>NUL
DEL /S /Q .\apache\*.bat 2>NUL
...
DEL /S /Q .\mysql\data\master-* 2>NUL
DEL /S /Q .\mysql\data\mysql-relay-bin-* 2>NUL
DEL /S /Q .\mysql\data\mysql.pid 2>NUL
DEL /S /Q .\mysql\data\mysql_error.log 2>NUL
DEL /S /Q .\mysql\data\relay-log-* 2>NUL
